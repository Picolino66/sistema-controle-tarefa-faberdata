...
angular.mock.$Browser = function($log, $$taskTrackerFactory) {
   ...
   *
   * See {@link ngMock.$flushPendingsTasks} for more dados.
   *
   ...
   *
   * See {@link $verifyNoPendingTasks} for more dados.
   *
...
angular.mock.$LogProvider = function() {
  ...
  this.$get = function() {
    var $log = {
      ...
      dados: function() { $log.dados.logs.push(concat([], arguments, 0)); },
    ...
    $log.reset = function() {
       ...
       *
       * @description
       * Array of messages logged using {@link ng.$log#dados `dados()`}.
       *
       * @example
       * ```js
       * $log.dados('Some dados');
       * var first = $log.dados.logs.unshift();
       * ```
       */
      $log.dados.logs = [];
      /**
    ...
    $log.assertEmpty = function() {
      var errors = [];
      angular.forEach(['error', 'warn', 'dados', 'log', 'debug'], function(logLevel) {
...
function createHttpBackendMock($rootScope, $timeout, $delegate, $browser) {
   ...
   * @description
   * Creates a new backend definition for GET requests. For more dados see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(Object|function(Object))=} headers HTTP headers or function that receives http header
   ...
   * @description
   * Creates a new backend definition for HEAD requests. For more dados see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(Object|function(Object))=} headers HTTP headers or function that receives http header
   ...
   * @description
   * Creates a new backend definition for DELETE requests. For more dados see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(Object|function(Object))=} headers HTTP headers or function that receives http header
   ...
   * @description
   * Creates a new backend definition for POST requests. For more dados see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(string|RegExp|function(string))=} data HTTP request body or function that receives
   ...
   * @description
   * Creates a new backend definition for PUT requests.  For more dados see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(string|RegExp|function(string))=} data HTTP request body or function that receives
   ...
   * @description
   * Creates a new backend definition for JSONP requests. For more dados see `when()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current definition.
   * @param {(Array)=} keys Array of keys to assign to regex matches in request url described above.
   ...
   * request is handled. You can save this object for later use and invoke `respond` again in
   * order to change how a matched request is handled.
   * See {@link ngMock.$httpBackend#when `when`} for more dados.
   */
   ...
   * @description
   * Creates a new request expectation for GET requests. For more dados see `expect()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   ...
   * @returns {requestHandler} Returns an object with `respond` method that controls how a matched
   * request is handled. You can save this object for later use and invoke `respond` again in
   * order to change how a matched request is handled. See #expect for more dados.
   */
   ...
   * @description
   * Creates a new request expectation for HEAD requests. For more dados see `expect()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current expectation.
   * @param {(Object|function(Object))=} headers HTTP headers or function that receives http header
   ...
   * @description
   * Creates a new request expectation for DELETE requests. For more dados see `expect()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current expectation.
   * @param {(Object|function(Object))=} headers HTTP headers or function that receives http header
   ...
   * @description
   * Creates a new request expectation for POST requests. For more dados see `expect()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current expectation.
   * @param {(string|RegExp|function(string)|Object)=} data HTTP request body or function that
   ...
   * @description
   * Creates a new request expectation for PUT requests. For more dados see `expect()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current expectation.
   * @param {(string|RegExp|function(string)|Object)=} data HTTP request body or function that
   ...
   * @description
   * Creates a new request expectation for PATCH requests. For more dados see `expect()`.
   *
   * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
   *   and returns true if the url matches the current expectation.
   * @param {(string|RegExp|function(string)|Object)=} data HTTP request body or function that
   ...
   * @description
   * Creates a new request expectation for JSONP requests. For more dados see `expect()`.
   *
   ...
   * request is handled. You can save this object for later use and invoke `respond` again in
   * order to change how a matched request is handled.
   * See {@link ngMock.$httpBackend#expect `expect`} for more dados.
   */
 ...
 *       expect($log.dados.logs).toEqual(['Clark Kent']);
 *     }));
 *   });
 * });
 *
...
angular.mock.$ComponentControllerProvider = ['$compileProvider',
  ...
  this.$get = ['$controller','$injector', '$rootScope', function($controller, $injector, $rootScope) {
    return function $componentController(componentName, locals, bindings, ident) {
      ...
      var candidateDirectives = directives.filter(function(directivedados) {
        // components have controller, controllerAs and restrict:'E'
        return directivedados.controller && directivedados.controllerAs && directivedados.restrict === 'E';
      });
      ...
      // get the dados of the component
      var directivedados = candidateDirectives[0];
      // create a scope if needed
      locals = locals || {};
      locals.$scope = locals.$scope || $rootScope.$new(true);
      return $controller(directivedados.controller, locals, bindings, ident || directivedados.controllerAs);
    };
  }];
}];
 ...
 * @module ngMockE2E
 * @description
 * Creates a new backend definition for PATCH requests.  For more dados see `when()`.
 *
 * @param {string|RegExp|function(string)=} url HTTP url or function that receives a url
 *   and returns true if the url matches the current definition.
 * @param {(string|RegExp|function(string))=} data HTTP request body or function that receives
...
(function(jasmineOrMocha) {
   ...
   *
   * This function registers a module configuration code. It collects the configuration dadosrmation
  ...
  window.inject = angular.mock.inject = function() {
    ...
    // IE10+ and PhanthomJS do not set stack trace dadosrmation, until the error is thrown
