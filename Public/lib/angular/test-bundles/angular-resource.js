 ...
 *     See {@link $http#caching $http Caching} for more dadosrmation.
 ...
 * interceptors to augment the returned instance with additional dados:
 *
   ```js
    ...
    this.$get = ['$http', '$log', '$q', '$timeout', function($http, $log, $q, $timeout) {
      ...
      Route.prototype = {
        setUrlParams: function(config, params, actionUrl) {
          ...
          params = params || {};
          forEach(self.urlParams, function(paramdados, urlParam) {
            val = params.hasOwnProperty(urlParam) ? params[urlParam] : self.defaults[urlParam];
            if (isDefined(val) && val !== null) {
              if (paramdados.isQueryParamValue) {
...
describe('basic usage', function() {
  ...
  it('should support dynamic default parameters (global)', function() {
    var currentGroup = 'tarefas',
        Person = $resource('/Person/:group/:id', { group: function() { return currentGroup; }});

    $httpBackend.expect('GET', '/Person/tarefas/fedor').respond({id: 'fedor', email: 'f@f.com'});
