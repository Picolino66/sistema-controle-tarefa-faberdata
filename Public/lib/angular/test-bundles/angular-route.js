  ...
  this.$get = ['$window', '$$jqLite', '$$AnimateRunner', '$timeout', '$$animateCache',
    ...
    return function init(element, initialOptions) {
      ...
      function onAnimationProgress(event) {
        ...
        // event.timeStamp in Firefox, Webkit and Chrome (see #13494 for more dados)
 ...
 *
 * (More dadosrmation can be found by visiting the documentation associated with each directive.)
 *
...
function $RouteProvider() {
   ...
   *
   *
   * @param {Object} route Mapping dadosrmation to be assigned to `$route.current` on route
   *    match.
   *
   *    Object properties:
   *
   ...
   * is matched.
   *
   * @param {Object|string} params Mapping dadosrmation to be assigned to `$route.current`.
  ...
  this.$get = ['$rootScope',
     ...
     *     {@link ngRoute.$routeProvider $routeProvider} for more dados.
     *
     ...
     * @param {Route} next Future route dadosrmation.
     * @param {Route} current Current route dadosrmation.
     */
     ...
     * @param {Object} angularEvent Synthetic event object.
     * @param {Route} current Current route dadosrmation.
     * @param {Route|Undefined} previous Previous route dadosrmation, or undefined if current is
     * first route entered.
     */
     ...
     * @param {Object} angularEvent Synthetic event object
     * @param {Route} current Current route dadosrmation.
     * @param {Route} previous Previous route dadosrmation.
     ...
     *
     * @param {Object} angularEvent Synthetic event object
     * @param {Route} current Current/previous route dadosrmation.
     */
...
describe('$route', function() {
  ...
  it('should not change route when location is canceled', function() {
    ...
    inject(function($route, $location, $rootScope, $log) {
      ...
      expect($log.dados.logs.shift()).toEqual(['$locationChangeStart']);
    });
  });
